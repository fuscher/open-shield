...
if not exist "%POLICY_FILE%" (
    %PYTHON_CMD% -c "import json; from pathlib import Path; p=Path(r'%POLICY_FILE%'); p.write_text(json.dumps({'blacklist':['/etc/**','/boot/**','~/.ssh/**','~/.gnupg/**','C:\\Windows\\**','C:\\Program Files\\**','**/.env','**/credentials','**/id_rsa','**/*.pem'],'whitelist':['/tmp/**','/home/*/projects/**','~/work/**','D:\\Git\\**','C:\\Users\\*\\Documents\\**'],'sensitive_read_patterns':['~/.ssh/**','~/.aws/**','**/.env','**/config.json','/etc/passwd','/etc/shadow'],'learning_mode':True,'browser_passwords':{'enabled':True,'rules':[{'browser':'Chrome','patterns':{'win32':r'%%LOCALAPPDATA%%\Google\Chrome\User Data\*\Login Data','darwin':'~/Library/Application Support/Google/Chrome/*/Login Data','linux':'~/.config/google-chrome/*/Login Data'},'action':'block','description':'Chrome 浏览器密码数据库'},{'browser':'Edge','patterns':{'win32':r'%%LOCALAPPDATA%%\Microsoft\Edge\User Data\*\Login Data','darwin':'~/Library/Application Support/Microsoft Edge/*/Login Data','linux':'~/.config/microsoft-edge/*/Login Data'},'action':'block','description':'Edge 浏览器密码数据库'},{'browser':'Firefox','patterns':{'win32':r'%%APPDATA%%\Mozilla\Firefox\Profiles\*\logins.json','darwin':'~/Library/Application Support/Firefox/Profiles/*/logins.json','linux':'~/.mozilla/firefox/*/logins.json'},'action':'block','description':'Firefox 浏览器密码文件'}]}},indent=2))"
